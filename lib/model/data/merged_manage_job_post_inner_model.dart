...
part 'merged_manage_job_post_inner_model.freezed.dart';


@freezed
class MergedManageJobPostInnerModel with _$MergedManageJobPostInnerModel {
  const factory MergedManageJobPostInnerModel({
    required ApplicationModel applicationModel,
    required UserModel applicantModel,
    
  }) = _MergedManageJobPostInnerModel;
