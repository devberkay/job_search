...
part 'merged_job_post_manage_model.freezed.dart';


@freezed
class MergedJobPostManageModel with _$MergedJobPostManageModel {
  const factory MergedJobPostManageModel({
    required ApplicationModel applicationModel,
    required JobModel jobModel,
    required UserModel applicantModel,
    
  }) = _MergedJobPostManageModel;
